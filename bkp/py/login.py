...
from py.cadastro import Ui_Cadastro  # Certifique-se de que a importação esteja correta
...
class Ui_Form(object):
    ...
    def abrir_tela_cadastro(self):
        ...
        self.window(Ui_Form).close(Ui_Form)  # Fecha a janela atual (login)
        ...
        self.cadastro_window.show(Ui_Cadastro)  # Exibe a janela de cadastro
